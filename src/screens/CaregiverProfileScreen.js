...
//       <View>
//         <Text style={{fontSize:15,fontWeight:'bold', marginTop: -58,left:120}}> Required experience</Text>
...
//   <Text style={{fontSize:18,fontWeight:'bold',right:75, marginTop: 10}}>Searching for</Text>
...
const CaregiverProfileScreen = () => {
  return (
    <View>
      <Text>CaregiverProfileScreen</Text>
    </View>
  )
}
