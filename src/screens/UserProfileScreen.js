...
//   useEffect(() => {
//     if (route.params && route.params.desiredUser && users.length > 0) {
//       const otherUser = users.find(
//         (user) => user.userId !== route.params.desiredUser
//       );
//       if (otherUser) {
//         navigation.navigate("OtherUserProfile", { user: otherUser });
//       }
//     }
//   }, [route.params, users, navigation]);
